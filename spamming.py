...
Original file is located at
    https://colab.research.google.com/drive/13rPnfEs8xFTtil0WyVwvbw8yA1ZAfsXF
"""
...
# download  all required NLTK NLTK resources
nltk.download('punkt')
...
df = pd.read_csv('/content/drive/MyDrive/my data/spam (1).csv', encoding='latin-1')
df.head()
...
sns.barplot(data=spam_words, x='word', y='count' , color='red')
